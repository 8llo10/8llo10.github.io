...
import { z } from "zod";
const Settings=z.object({name:z.string(),role:z.string(),location:z.string(),email:z.string(),linkedin_url:z.string(),github_url:z.string(),cv_url:z.string(),availability:z.string(),logo_url:z.string().optional().default("")});
